...
function preload() {
  tea = loadImage('assets/tea.gif');
  circle1 = loadImage('assets/circle1.gif');
}
...
push();
    ...
    //mouth
    rect (2,27,20,15 * noise(0.09*frameCount + 60));
